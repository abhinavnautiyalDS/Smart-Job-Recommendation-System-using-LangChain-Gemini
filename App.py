...
def main():
    ...
    body, .stApp, .css-1aumxhk, .st-emotion-cache-1aumxhk {
        ...
        background-image: url("https://plus.unsplash.com/premium_photo-1671976322695-803d996cecdc?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D");
